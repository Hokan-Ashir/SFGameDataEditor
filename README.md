...
# What it can't do
 - Currently only support for changing skill-to-characteristics requirements, spells parameters, creatures common parameters, armor, weapons and miscellaneous items common parameters
