...
/**
 * {@link ShowViewEvent}s can be fired to the {@link EventBus} and the {@link EventBus}
...
public class EventBus {
    ...
    /**
     * Get the Class of the {@link ShowViewEvent}.
     * The passed {@link Method} must be a valid {@link EventHandler}-annotated
     * method with exactly one parameter (the {@link ShowViewEvent}).
     ...
     * the {@link EventBus}. That means, that future fired {@link ShowViewEvent}s are no longer
