            ...
            try {
                ...
                if (dtoClass.equals(CreaturesCommonParameterObject.class)) {
                    ...
                    if (creatureSpells == null || creatureSpells.isEmpty()) {
                        getView().getTabPane().setEnabledAt(UnitsParametersView.CREATURE_SPELLS_TAB_INDEX, false);
                    } else {
                        getView().getTabPane().setEnabledAt(UnitsParametersView.CREATURE_SPELLS_TAB_INDEX, true);
