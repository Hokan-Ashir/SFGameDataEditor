...
public class RunesRequirementClassSubClassWidgetListener extends AbstractRequirementClassSubClassWidgetListener {

    public RunesRequirementClassSubClassWidgetListener(RequirementClassSubClassWidget widget, Field[] DTOField) {
